...
public class consultanteDto
{
    ...
    public consultanteDto(int i_doc_identificacion, String c_APELLIDOS, String c_GENERO, int i_TIPO_DOC, String c_NOMBRES, int i_LUGAR_EXPEDICION, int i_EDAD, int i_ID_CONSULTANTE, String c_ESTADO_CIVIL, String c_TIPO_VIVIENDA, String c_DIRECCION, String c_TELEFONO_PERSONAL, String c_EMPRESA, String c_TELEFONO_EMPRESA, double i_INGRESOS_MENSUALES, int i_PERSONAS_A_CARGO, String c_DESPLAZADO, String c_OCUPACION, String c_TRABAJA, String c_PER_RED_UNIDOS, int c_ESTRATO, int c_SISBEN, int NIVEL_ESTUDIOS)
    {
